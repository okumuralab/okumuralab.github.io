quartz(type="png", file="one-two.png", width=7, height=7, bg="white", family="HiraKakuProN-W3")
...
for (lambda in seq(0,20,0.1)) {
    ...
    segments(x[1], lambda, x[2], lambda, col="#ff9900")
}
for (lambda in seq(0,20,0.1)) {
    ...
    segments(x[1], lambda+0.05, x[2], lambda+0.05, col="#66ccff")
}
dev.off()
